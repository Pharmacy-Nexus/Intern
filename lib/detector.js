...
If this is a medical or safety situation, please describe what happened and include:

- Age/sex if known
- Main symptom or injury
- Conscious or unconscious? Breathing normally?
- Any chest pain, severe bleeding, seizure, allergic reaction, or trauma?
- Current medicines or known diseases if relevant

> [!WARNING] If there is loss of consciousness, severe breathing difficulty, heavy bleeding, chest pain, seizure, or severe trauma, seek emergency help immediately.`;
}
...
function isMedicalInScope(text = '', data) {
  ...
  const medicalTerms = [
    ...
    'دواء', 'ادوية', 'أدوية', 'دوا', 'جرعة', 'اعراض', 'أعراض', 'تفاعل', 'تداخل', 'صيدلة', 'صيدلي', 'مريض', 'حالة', 'تحاليل', 'تحليل', 'تشخيص', 'علاج', 'مضاد', 'حامل', 'حمل', 'ضغط', 'سكر', 'كلى', 'كلية', 'كبد', 'حساسية', 'موانع', 'متابعة', 'مذاكرة فارما', 'فارما', 'كلينيكال', 'طبي', 'ميديكال', 'مادة فعالة', 'مادة إضافية', 'مادة اضافية', 'سواغ', 'تصنيع', 'تركيبة', 'طوارئ', 'اسعاف', 'إسعاف', 'نزيف', 'اغماء', 'إغماء', 'تشنج', 'اختناق', 'حادث', 'وقعة', 'كسر', 'جرح', 'بيتنفس', 'مش بيتنفس'
  ];
  return isVagueHumanQuestion(text) || medicalTerms.some(term => t.includes(term));
}
